...
export default defineInstrument({
  kind: 'FORM',
  language: 'en',
  tags: ['End of Life', 'Marmoset', 'Euthanasia', 'Termination'],
  internal: {
    edition: 1,
    name: 'MARMOSET_END_OF_LIFE_FORM'
  },
  content: {
    terminationReason: {
      kind: 'string',
  ...
  details: {
    description: 'Form to fill in info of Marmoset end of life',
    license: 'Apache-2.0',
    title: 'Marmoset End Of Life Form'
  },
  clientDetails: {
    estimatedDuration: 1,
    instructions: ['Please fill in this for when a marmoset reaches the end of its life']
  },
  measures: {
     terminationReason: {
      kind: "const",
