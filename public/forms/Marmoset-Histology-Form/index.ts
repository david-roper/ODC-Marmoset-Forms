...
export default defineInstrument({
    ...
    antibodiesUsedInfo: {
      ...
      fieldset: {
        ...
        antibodyDuration: {
          kind:"number",
          variant: "select",
          label: "Time antibody was in sample for",
          options: {
            18: "3/4 day",
            12: "half day"
          }
  ...
  validationSchema: z.object({
    ...
    protocolFollowed: z.enum(["CoBrA Lab","Western University", "Other"]),
