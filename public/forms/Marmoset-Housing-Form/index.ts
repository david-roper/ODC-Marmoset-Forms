...
export default defineInstrument({
  ...
  content: {
    ...
    totalMarmosets: {
      kind: "number",
      variant: "input",
      label: "Number of marmosets in cage"
    },
  ...
  clientDetails: {
    estimatedDuration: 1,
    instructions: ["Used to log a marmoset's housing information. Please fill out this form whenever a marmoset's housing is changed or if they moved to a new cage. Changes to a marmoset's housing include change in room, type of cage, number of cagemates, and if any cage enrichment is added."]
  },
  details: {
    description: "Describes a marmoset's housing details whenever it is moved or changed.",
    license: 'Apache-2.0',
    title: 'Marmoset Housing Form'
  },
  measures: {
    roomNumber: {
      kind: "const",
  ...
  validationSchema: z.object({
    ...
    totalMarmosets: z.number().int().min(0),
    ...
    cageEnrichment: z.set(z.enum(['Toys',"Cover","Tube","Enlarged Cage"])).optional(),
