...
export default defineInstrument({
  ...
  clientDetails: {
    estimatedDuration: 2,
    instructions: ['Please fill out this form whenever a Marmoset experiences an injection']
  },
  details: {
    description: 'A form to describe a Marmosets injection information',
    license: 'Apache-2.0',
