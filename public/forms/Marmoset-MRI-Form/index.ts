...
export default defineInstrument({
  kind: 'FORM',
  language: 'en',
  tags: ['marmoset', 'MRI', 'Structural', 'fMRI'],
  internal: {
    edition: 1,
    name: 'MARMOSET_MRI_FORM'
  },
  content: {
    mriOperatorName: {
      kind: "string",
    ...
    coilType: {
      ...
      options: {
        ...
        "marmoset surface coil": "marmoset surface coil",
        "4 coil array marmoset surface coil": "4 coil array marmoset surface coil",
  ...
  clientDetails: {
    estimatedDuration: 1,
    instructions: ['Use this form for an individual marmoset MRI sessions, which can contain multiple scans of different kinds. It is expected that the type of scan that are done on the marmoset as well as certain information such as breath rate, and oxygenation level from the MRI monitor for certain scans. When recording the scans please put them in the exact order they were done within the session.'],
  ...
  validationSchema: z.object({
    ...
    coilType: z.enum([
      ...
      "marmoset surface coil",
      "4 coil array marmoset surface coil",
      "10 mm loop coil",
      "30 mm loop coil"
    ]),
    ...
    scanRecordInfo: z.array(z.object({
      ...
      marmosetVitalsTracked: z.boolean().optional(),
