...
export default defineInstrument({
  ...
  clientDetails: {
    estimatedDuration: 3,
    instructions: ['Please fill this form whenever a marmoset has to through a surgery or has gone through veterinary care. If the wound treatment section is selected to be filled in, please use the information written on the card provided by the veterinary team']
  },
  details: {
    description: 'Describes the information about a physical intervention done upon a marmoset, either in the form of as surgery or as a wound treatment done by the veterinary team.',
    license: 'Apache-2.0',
    title: 'Marmoset Surgery and Wound Treatment Form'
  },
  measures: {
    treatmentType: {
      kind: "const",
  ...
  validationSchema: z.object({
      ...
      surgeryType: z.enum(["Ovariectomy", "Electrode implant", "Fiber optic implant", "Vasectomy"]).optional(),
      ovariectomyType: z.enum(["Unilateral", "Bilateral"]).optional(),
      ovariectomymarmosetGroup: z.enum(["Control", "Experiment"]).optional(),
